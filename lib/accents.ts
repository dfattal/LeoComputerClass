...
export const accents: Record<string, Accent> = {
  ...
  blue: {
    ...
    handleHover: "group-hover:bg-blue-400 dark:group-hover:bg-blue-500",
    sidebar: "bg-blue-600 font-medium text-white shadow-sm shadow-blue-600/25",
    feedback: {
  ...
  cyan: {
    ...
    handleHover: "group-hover:bg-cyan-400 dark:group-hover:bg-cyan-500",
    sidebar: "bg-cyan-600 font-medium text-white shadow-sm shadow-cyan-600/25",
    feedback: {
      border: "border-cyan-200 dark:border-cyan-800",
      bg: "bg-cyan-50 dark:bg-cyan-950/40",
      title: "text-cyan-800 dark:text-cyan-200",
      body: "text-cyan-900 dark:text-cyan-100",
    },
    cardBorder: "hover:border-cyan-400 dark:hover:border-cyan-500",
  ...
  red: {
    ...
    underline: "bg-red-600 dark:bg-red-400",
    ring: "focus-visible:ring-red-500",
    handleHover: "group-hover:bg-red-400 dark:group-hover:bg-red-500",
    sidebar: "bg-red-600 font-medium text-white shadow-sm shadow-red-600/25",
    feedback: {
